      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 text-sm">
            ...
            <Link className="text-textColor">{data.user.username}</Link>
            <span>on</span>
            <Link className="text-textColor">{data.category}</Link>
        ...
        {data.img && (
          <div className="hidden lg:block w-2/5">
            <Image src={data.img} w="400" h="400" className="rounded-2xl" />
          </div>
        )}
      </div>
      {/* content */}
