      ...
      <div className="flex flex-col gap-2 text-sm">
        <label htmlFor="" className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            value="newest"
            className="appearance-none w-4 h-4 border-[1.5px] border-grey-800 cursor-pointer rounded-sm bg-white checked:bg-primary"
          />
          Newest
        </label>
        <label htmlFor="" className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            onChange={handleFilterChange}
            value="popular"
            className="appearance-none w-4 h-4 border-[1.5px] bborder-grey-800 cursor-pointer rounded-sm bg-white checked:bg-primary"
          />
          Most Popular
        </label>
        <label htmlFor="" className="flex items-center gap-2 cursor-pointer">
